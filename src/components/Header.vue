<template>
  <div class="hamburger-menu">
    <router-link class="logo d-lg-none" to="/">  <img src="@/assets/img/logo.png" alt="oan logo"></router-link>
    <button @click="toggleMobileMenu" class="hamburger hamburger--slider" :class="{'is-active': store.isMobileMenuVisible}" type="button">
          ...
          <div class="row d-flex flex-column flex-lg-row align-items-center">
            ...
            <div class="col-12 col-lg-8 nav--wrapper">
              <nav class="d-flex flex-column flex-lg-row align-items-center" data-aos="fade-up">
                ...
                <LangSwitcher/>
                <router-link class="oan-btn" active-class="no-top-underline" to="/contact">Napisz do nas</router-link>
              </nav>
            </div>
          </div>
        </div>
